...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Capitan Cloud" },
      { property: "og:title", content: "Diventa Cloud Engineer in 90 Giorni — Capitan Cloud" },
      {
        property: "og:description",
        content:
          "Percorso completo + 2 certificazioni AWS + Protocollo Subito Assunto!™. Da zero, senza laurea, in 90 giorni.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Figtree:wght@400;500;600;700;800&family=Inter:wght@400;500;600;700&family=Outfit:wght@500;600;700;800&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap",
      },
    ],
