...
const PRICE = "297€";
const WHATSAPP_NUMBER = "393293624394";
        ...
        <div className="border-t border-black/5 bg-white px-4 py-4 lg:hidden">
          <nav className="flex flex-col gap-3">
            <a
              ...
              className="rounded-lg px-3 py-2 font-semibold text-brand-blue hover:bg-black/5"
            >
              Home
            </a>
            <a
      ...
      <div className="relative mx-auto max-w-3xl">
        <div className="rounded-3xl bg-white p-8 text-brand-ink shadow-2xl sm:p-12">
          <div className="text-center">
            ...
            <div className="mt-6 rounded-2xl border-2 border-[#25D366]/30 bg-[#25D366]/5 p-5">
              <p className="mb-3 text-sm font-semibold text-brand-ink">
                Hai dubbi se fa per te? Scrivimi direttamente su WhatsApp.
              </p>
              <a
                href={WHATSAPP_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex w-full items-center justify-center gap-3 rounded-xl bg-[#25D366] px-6 py-4 text-base font-bold text-white shadow-md shadow-[#25D366]/30 transition hover:brightness-110"
              >
                <svg
                  className="h-5 w-5"
                  viewBox="0 0 24 24"
              ...
              <p className="mt-3 text-xs font-semibold text-brand-ink/70">
                Ti risponde <span className="text-brand-blue">personalmente Eugenio</span> — niente
                venditori, niente call center. Di solito rispondo entro poche ore.
              </p>
            </div>
          </div>
