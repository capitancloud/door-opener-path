...
const articleSeeds: Array<Omit<BlogArticle, "published" | "readingTime" | "related">> = [
  ...
  { number: 6, slug: "aws-solutions-architect-associate", title: "AWS Solutions Architect Associate (SAA-C03): guida completa all'esame 2026", seoTitle: "AWS Solutions Architect Associate (SAA-C03): guida all'esame 2026", category: "Certificazioni AWS", description: "Tutto sull'esame AWS Solutions Architect Associate SAA-C03: domini e pesi, servizi da studiare, domande di scenario e piano di studio in 8 settimane." },
  { number: 7, slug: "devops-engineer", title: "DevOps engineer: cos'è, cosa fa e differenza con il cloud engineer", seoTitle: "DevOps engineer: cos'è, cosa fa e differenze col cloud engineer", category: "Carriera Cloud", description: "Cosa fa un DevOps engineer, quali competenze servono, quanto guadagna e che differenza c'è con il cloud engineer. Con il percorso per diventarlo." },
  ...
  { number: 15, slug: "aws-skill-builder", title: "AWS Skill Builder e corsi AWS gratis: cosa trovi e dove non bastano", seoTitle: "AWS Skill Builder e corsi AWS gratis: cosa trovi e i limiti", category: "Certificazioni AWS", description: "Cosa offre AWS Skill Builder gratis e a pagamento, gli altri corsi AWS gratuiti e dove le risorse gratuite non bastano per certificazione e lavoro." },
  ...
  { number: 23, slug: "docker", title: "Docker spiegato da zero: cos'è, come funziona e perché lo usano tutti", seoTitle: "Docker spiegato da zero: cos'è, come funziona e primi comandi", category: "Guide pratiche", description: "Docker spiegato da zero: cos'è un container, differenza con le macchine virtuali, primi comandi, Dockerfile, Docker Compose ed errori da evitare." },
  { number: 24, slug: "kubernetes", title: "Kubernetes per principianti: cos'è, come funziona e quando serve", seoTitle: "Kubernetes per principianti: cos'è, come funziona e quando serve", category: "Guide pratiche", description: "Kubernetes spiegato semplice: cos'è, Pod, Deployment e Service, un primo esempio con kubectl, dove provarlo e quando serve davvero (e quando no)." },
  { number: 25, slug: "linux-per-principianti", title: "Linux per principianti: i comandi base che devi sapere (2026)", seoTitle: "Linux per principianti: i comandi base che devi sapere (2026)", category: "Guide pratiche", description: "Linux per principianti: come iniziare senza cambiare computer, comandi di base, permessi, processi e rete, con un esercizio pratico ed errori da evitare." },
  { number: 26, slug: "aws-o-azure", title: "AWS o Azure: quale imparare per primo nel 2026?", seoTitle: "AWS o Azure: quale imparare per primo nel 2026?", category: "Carriera Cloud", description: "AWS o Azure per iniziare nel cloud? Differenze, servizi equivalenti, certificazioni a confronto e come capire quale piattaforma chiede il mercato vicino a te." },
  ...
  { number: 30, slug: "lavori-per-cambiare-vita", title: "Lavori per cambiare vita: le professioni che puoi imparare da adulto (2026)", seoTitle: "Lavori per cambiare vita: le professioni da imparare da adulto", category: "Cambio lavoro", description: "Lavori per cambiare vita a 30, 40 o 50 anni: 8 professioni da imparare da adulto, come funziona la riconversione professionale e gli errori da evitare." },
];
...
const RELATED_OVERRIDES: Record<string, string[]> = {
  ...
  "lavori-per-cambiare-vita": ["voglio-cambiare-lavoro", "cambiare-lavoro-mentre-lavori", "come-diventare-cloud-engineer"],
